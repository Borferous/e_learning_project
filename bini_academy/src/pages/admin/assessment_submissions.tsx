...
// Dummy data
const dummyDegrees = [
  { value: 'degree-1', label: 'Bachelor of Science' },
  { value: 'degree-2', label: 'Bachelor of Arts' }
];

const dummyCourses = [
  { value: 'course-1', label: 'Computer Science', degreeId: 'degree-1' },
  { value: 'course-2', label: 'Music', degreeId: 'degree-2' }
];

const dummySubjects = [
  { value: 'subject-1', label: 'Programming 101', courseId: 'course-1' },
