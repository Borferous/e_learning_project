...
export const AdvanceInfoTab = ({ setActiveTab, updateProgress }: AdvanceInfoTabProps) => {
  ...
  const countCompletedFields = () => {
    let completed = 0;
    let total = 8; // Description (1) + Teachings (up to 3) + Requirements (up to 3) + 2 uploads
  ...
  }, [formValues, uploads, updateProgress]);

  return (
    <>
      <h3 className="text-xl font-semibold mb-4">Advanced Information</h3>
      <p className="text-sm text-gray-500">
        Completed fields: {countCompletedFields().completed} / 8
      </p>
