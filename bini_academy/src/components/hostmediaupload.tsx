...
interface HostMediaUploadProps {
  onUpload: (uploadedFiles: { thumbnail: boolean; trailer: boolean }) => void;
}

export const HostMediaUpload = ({ onUpload }: HostMediaUploadProps) => {
  ...
  return (
    <div className="grid grid-cols-2 gap-6">
      ...
      <div className="border p-4 rounded-lg bg-white shadow-sm">
        <h4 className="text-lg font-semibold mb-2">Event Thumbnail</h4>
        <div className="relative w-full h-48 border-dashed border-2 border-gray-300 rounded-lg flex justify-center items-center bg-gray-100">
          {thumbnailURL ? (
            <img src={thumbnailURL} alt="Event Thumbnail" className="w-full h-full object-cover rounded-lg" />
          ) : (
            <img src={placeholderImage} alt="Placeholder Thumbnail" className="w-20 h-20" />
          )}
        </div>
        <p className="text-sm text-gray-500 mt-2">
          Upload your event thumbnail here. <strong>Important Guidelines:</strong> 1200×800 pixels or 12:8 Ratio. Supported formats: <b>.jpg, .jpeg, .png</b>.
        </p>
        <FileInput
          className="mt-2"
          label=""
      ...
      <div className="border p-4 rounded-lg bg-white shadow-sm">
        <h4 className="text-lg font-semibold mb-2">Event Trailer</h4>
        <div className="relative w-full h-48 border-dashed border-2 border-gray-300 rounded-lg flex justify-center items-center bg-gray-100">
          {trailerURL ? (
        ...
        <p className="text-sm text-gray-500 mt-2">
          A well-made promo video can boost engagement. Supported formats: <b>.mp4, .mov</b>.
        </p>
        <FileInput
          className="mt-2"
          label=""
